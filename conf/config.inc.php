<?php
	...
	$explode = explode("postgres://",$my_env_var);
	$username_explode = explode(":",$explode[1]);
	$password_explode = explode("@",$username_explode[1]);
	$hostname_explode = explode("/",$password_explode[1]);
	$database_explode = explode("/",$username_explode[2]);

	$username = $username_explode[0];
	$password = $password_explode[0];
	$hostname = $hostname_explode[0];
	$database = $database_explode[1];
	...
	$conf['servers'][0]['defaultdb'] = database;
